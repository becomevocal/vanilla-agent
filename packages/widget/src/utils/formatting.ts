    ...
    processChunk: (accumulatedContent: string): AgentWidgetStreamParserResult | string | null => {
      ...
      try {
        ...
        if (parsed && typeof parsed === "object") {
          // Check for component directives first - these don't have text fields
          if (parsed.component && typeof parsed.component === "string") {
            // For component directives, return empty text - component will be rendered separately
            extractedText = "";
          }
...
export const createFlexibleJsonStreamParser = (
  ...
  const defaultExtractor = (parsed: any): string | null => {
    ...
    // Check for component directives first - these don't have text fields
    if (parsed.component && typeof parsed.component === "string") {
      // For component directives, return a placeholder or empty string
      // The component will be rendered separately
      return "";
    }
