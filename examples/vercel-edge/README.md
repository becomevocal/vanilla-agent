...
This example uses shared flow configurations and utilities from `vanilla-agent-proxy`:

- **Flow configs**: `SHOPPING_ASSISTANT_FLOW` from `vanilla-agent-proxy/flows`
- **Stripe helpers**: `createCheckoutSession` from `vanilla-agent-proxy/utils`
